...
export default function Dolar(){
    const [valorMoedaDolar, setValorMoedaDolar] = useState(null);
    async function atualizar(){
        console.log("entrou nessa função")
        try{
          const response = await buscarCotacao("USD-BRL");
          console.log(response.data);
          setValorMoedaDolar(response.data);
          console.log(valorMoedaDolar)
        } catch(error){
    ...
    return(
      <View style={styles.container}>
        ...
        <Text style={styles.preco}>R$ {valorMoedaDolar.ask}</Text>
